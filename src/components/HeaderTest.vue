              ...
              <div class="position-relative">
                ...
                <div class="absolute-dropdown">
                  <ul class="">
                    ...
                    <router-link to="/">
                      <li class="list-group-item"><a class="dropdown-item text-dark" href="#">Okul Listeleri</a></li>
                    </router-link>
                  </ul>
                </div>
              </div>
                ...
                <div class="absolute-dropdown">
                  <ul class="">
                    <router-link to="/sign-up">
                      <li class="list-group-item"><a class="dropdown-item text-dark" href="#">Kullanıcı Ekle</a>
                      </li>
                    </router-link>
